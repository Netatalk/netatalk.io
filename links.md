...
| [afpfs-ng](https://sourceforge.net/projects/afpfs-ng/) | Cross-platform AFP client library with CLI and FUSE clients |  |
| [afpfs-ng (fork)](https://github.com/Netatalk/afpfs-ng) | Improved fork of afpfs-ng under the Netatalk project |  |
...
| [macipgw](https://macipgw.sourceforge.io) | [MacIP](https://en.wikipedia.org/wiki/MacIP) bridge for LocalTalk-only Macs | Bundled with Netatalk as of v4.0 |
