...
If you think you have found a bug in Netatalk, first see if the bug has already been reported in the
[Netatalk issue tracker on GitHub](https://github.com/Netatalk/netatalk/issues).
...
In the case you cannot use GitHub to report the bug, please use the *netatalk-admins* mailing list
as described below instead.
...
on SourceForge is a place where project admins and the general public can discuss any netatalk topic.
